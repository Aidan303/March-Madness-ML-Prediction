...
def run_one(run_id: str, feature_set: str) -> None:
    csv_path = BRACKET_DATASET[feature_set]
...
def main() -> None:
    ...
    set1 = rr.loc[rr["run_id"] == "BRK_TREE_SET1", "feature_set"].iloc[0]
    set2 = rr.loc[rr["run_id"] == "BRK_TREE_SET2", "feature_set"].iloc[0]

    run_one("BRK_TREE_SET1", str(set1))
    run_one("BRK_TREE_SET2", str(set2))
